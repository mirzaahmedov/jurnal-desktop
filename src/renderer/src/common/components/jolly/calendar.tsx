      ...
      className={composeRenderProps(className, (className, renderProps) =>
        cn(
          ...
          renderProps.isSelected &&
            'bg-brand text-primary-foreground data-[focused]:bg-brand  data-[focused]:text-primary-foreground',
          /* Hover */
          renderProps.isHovered &&
            renderProps.isSelected &&
            (renderProps.isSelectionStart || renderProps.isSelectionEnd || !isRange) &&
            'data-[hovered]:bg-brand data-[hovered]:text-primary-foreground',
          /* Selection Start/End */
          renderProps.isSelected &&
            isRange &&
          ...
          /* Unavailable Date */
          renderProps.isUnavailable && 'pointer-events-none cursor-default opacity-50 ',
