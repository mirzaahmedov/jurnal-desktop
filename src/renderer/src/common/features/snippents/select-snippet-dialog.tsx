...
export const SelectSnippetDialog = ({
  ...
  return (
    ...
    >
      <DialogOverlay>
        <DialogContent className="max-w-4xl h-full max-h-[800px] p-0">
          <div className="h-full overflow-hidden flex flex-col divide-y">
            <div className="p-5">
              <Debouncer
                value={searchValue}
            ...
            <ul className="divide-y flex-1 overflow-y-auto scrollbar">
