...
export interface SaldoUpdateManagerProps {
  queue: MonthValue[]
  completed: MonthValue[]
  pending: boolean
  error: Error | null
  onConfirm?: (month: MonthValue) => void
  onClose?: () => void
}
export const SaldoUpdateManager = ({
  queue,
  completed,
  pending,
  error,
  onConfirm,
  onClose
}: SaldoUpdateManagerProps) => {
  const dialogToggle = useToggle()
  const onCloseEvent = useEventCallback(onClose)
  ...
  }, [dialogToggle.isOpen, onCloseEvent])
...
const AlertIcon = (props: SVGAttributes<SVGElement>) => {
  return (
    <svg
      viewBox="0 0 445 445"
      fill="none"
    ...
    >
      ...
      <circle
        ...
        strokeWidth={4}
      />
      <g filter="url(#filter0_f_102_208)">
        <path
      ...
      <path
        d="M414.58 273L419.599 286.562L433.161 291.58L419.599 296.599L414.58 310.161L409.562 296.599L396 291.58L409.562 286.562L414.58 273Z"
        fill="#8BB2FF"
      />
      <rect
        x={106}
      ...
      />
      <g filter="url(#filter1_f_102_208)">
        <path
          d="M148.392 39L154.44 55.344L170.784 61.3918L154.44 67.4396L148.392 83.7836L142.344 67.4396L126 61.3918L142.344 55.344L148.392 39Z"
          fill="#8BB2FF"
        />
      </g>
      <rect
      ...
      <circle
        ...
        cy="292.216"
        r="58.3107"
        transform="rotate(-60 275.216 292.216)"
        fill="#F6F9FF"
        stroke="#538FFF"
        strokeWidth={14}
      />
      <rect
        ...
        height="82.165"
        rx={9}
        transform="rotate(-60 318.826 328.341)"
        fill="#538FFF"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M254.216 305.543C252.159 307.6 252.159 310.935 254.216 312.992C256.273 315.049 259.608 315.049 261.665 312.992L274.7 299.957L287.735 312.992C289.792 315.049 293.127 315.049 295.184 312.992C297.241 310.935 297.241 307.6 295.184 305.543L282.149 292.508L295.184 279.473C297.241 277.416 297.241 274.081 295.184 272.025C293.127 269.968 289.792 269.968 287.735 272.025L274.7 285.06L261.665 272.025C259.608 269.968 256.273 269.968 254.216 272.025C252.159 274.081 252.159 277.416 254.216 279.473L267.251 292.508L254.216 305.543Z"
        fill="#FF4F75"
      />
      <path
        d="M71.841 318.144C74.0717 318.742 74.8188 321.53 73.1858 323.163L62.1631 334.186C60.5301 335.819 57.7418 335.072 57.144 332.841L53.1094 317.784C52.5117 315.553 54.553 313.512 56.7837 314.109L71.841 318.144Z"
        fill="#8CB3FF"
      />
      <defs>
        <filter
          id="filter0_f_102_208"
          x={69}
          y={230}
          width={33}
          height={33}
...
export const ErrorIcon = () => {
  return <AlertTriangle className="block size-32 text-red-400" />
}
