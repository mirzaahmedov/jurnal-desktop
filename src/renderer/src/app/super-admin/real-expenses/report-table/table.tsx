        ...
        <TableHeader>
          ...
          <ReportTableRow className="bg-slate-100">
            {Array(11)
              ...
              .map(() => (
                <>
                  <ReportTableHead className="text-center">{t('kredit')}</ReportTableHead>
                  <ReportTableHead className="text-center">{t('debet')}</ReportTableHead>
                </>
              ))}
          </ReportTableRow>
        </TableHeader>
                    ...
                    return (
                      ...
                      >
                        {column.cellElement ? (
                          ...
                          formatNumber(Number(row[column.key as keyof ExpensesTableRow] || '0'))
                        ) : (
                          row[column.key as keyof ExpensesTableRow]
                        )}
                      </ReportTableCell>
                    )
                  }
