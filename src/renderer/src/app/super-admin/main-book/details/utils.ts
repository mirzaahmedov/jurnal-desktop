import type { AdminMainbookDetails, Schet } from '@renderer/common/models'

type NormalizedSchet = Schet & { type: string }

export const transformData = (data: AdminMainbookDetails) => {
  const schets = data.data
