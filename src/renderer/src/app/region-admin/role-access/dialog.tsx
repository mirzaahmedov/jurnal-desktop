...
export const RoleAccessDialog = ({ roleId, isOpen, onOpenChange }: RoleAccessDialogProps) => {
  ...
  const onSubmit = form.handleSubmit((values) => {
    ...
    updateRoleAccess({
      ...
      jur3: values.jur3,
      jur4: values.jur4,
      jur5: values.zarplata,
      zarplata: values.zarplata,
      zarplata_1: values.zarplata_1,
      zarplata_2: values.zarplata_2,
      zarplata_3: values.zarplata_3,
      zarplata_4: values.zarplata_4,
      zarplata_5: values.zarplata_5,
      jur7: values.jur7,
      jur8: values.jur8,
